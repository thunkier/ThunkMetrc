...
public class SublocationsExtensions {

    /**
     * Iterator for getActiveSublocations.
     * Returns an Iterable that fetches pages lazily and yields items.
     */
    @SuppressWarnings("unchecked")
    public static Iterable<Sublocation> iterateGetActiveSublocations(
        SublocationsService service,
        String lastModifiedEnd, String lastModifiedStart, String licenseNumber, String pageSize
            ...
            try {
                Object res = service.getActiveSublocations(
     ...
     */
    public static List<Sublocation> syncGetActiveSublocations(
        SublocationsService service,
        ...
        List<Sublocation> results = new ArrayList<>();

        for (Sublocation item : iterateGetActiveSublocations(service, endStr, startStr, licenseNumber, pageSize)) {
            results.add(item);
        }
        return results;
    }
     ...
     */
    public static Map<String, List<Sublocation>> syncGetActiveSublocationsParallel(
        ...
        return MetrcExtensions.syncParallel(targets, concurrencyLimit, (client, limiter, license) -> {
            SublocationsService svc = new SublocationsService(client, limiter);
            return syncGetActiveSublocations(
                svc,
    ...
    /**
     * Iterator for getInactiveSublocations.
     * Returns an Iterable that fetches pages lazily and yields items.
     */
    @SuppressWarnings("unchecked")
    public static Iterable<Sublocation> iterateGetInactiveSublocations(
        SublocationsService service,
        String licenseNumber, String pageSize
    ) {return MetrcExtensions.iteratePages(page -> {
            try {
                Object res = service.getInactiveSublocations(
