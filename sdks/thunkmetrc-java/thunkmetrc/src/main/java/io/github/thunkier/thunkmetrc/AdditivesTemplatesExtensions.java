...
public class AdditivesTemplatesExtensions {
    ...
    public static Iterable<AdditivesTemplate> iterateGetActiveAdditivesTemplates(
        AdditivesTemplatesService service,
        String lastModifiedEnd, String lastModifiedStart, String licenseNumber, String pageSize
            ...
            try {
                Object res = service.getActiveAdditivesTemplates(
     ...
     */
    public static List<AdditivesTemplate> syncGetActiveAdditivesTemplates(
        AdditivesTemplatesService service,
        ...
        List<AdditivesTemplate> results = new ArrayList<>();

        for (AdditivesTemplate item : iterateGetActiveAdditivesTemplates(service, endStr, startStr, licenseNumber, pageSize)) {
            results.add(item);
        }
        return results;
    }
     ...
     */
    public static Map<String, List<AdditivesTemplate>> syncGetActiveAdditivesTemplatesParallel(
        ...
        return MetrcExtensions.syncParallel(targets, concurrencyLimit, (client, limiter, license) -> {
            AdditivesTemplatesService svc = new AdditivesTemplatesService(client, limiter);
            return syncGetActiveAdditivesTemplates(
                svc,
     ...
     */
    @SuppressWarnings("unchecked")
    public static Iterable<AdditivesTemplate> iterateGetInactiveAdditivesTemplates(
        AdditivesTemplatesService service,
        String licenseNumber, String pageSize
    ) {return MetrcExtensions.iteratePages(page -> {
            try {
                Object res = service.getInactiveAdditivesTemplates(
