...
import com.fasterxml.jackson.annotation.JsonProperty;public class UpdateDeliveriesCompleteRequest {
    ...
    public static class UpdateDeliveriesCompleteRequestReturnedPackagesItem {
    @JsonProperty("Label")
    public String label;
