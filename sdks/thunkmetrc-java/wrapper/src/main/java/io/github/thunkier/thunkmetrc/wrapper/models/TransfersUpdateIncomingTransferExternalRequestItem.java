...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersUpdateIncomingTransferExternalRequestItem {
    @JsonProperty("Destinations")
    public List<TransfersUpdateIncomingTransferExternalRequestItemDestinations> destinations;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersUpdateIncomingTransferExternalRequestItemDestinations {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
