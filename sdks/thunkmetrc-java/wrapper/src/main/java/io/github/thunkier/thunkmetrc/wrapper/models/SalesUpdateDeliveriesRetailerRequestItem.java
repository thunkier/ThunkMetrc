...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesUpdateDeliveriesRetailerRequestItem {
    ...
    public static class SalesUpdateDeliveriesRetailerRequestItemDestinationsItemTransactionsItem {
...
}public static class SalesUpdateDeliveriesRetailerRequestItemDestinationsItem {
    ...
    public static class SalesUpdateDeliveriesRetailerRequestItemPackagesItem {
    @JsonProperty("DateTime")
    public String dateTime;
    @JsonProperty("PackageLabel")
    public String packageLabel;
