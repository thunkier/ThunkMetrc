...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreateAdditivesTemplatesRequest {
    ...
    public static class CreateAdditivesTemplatesRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
