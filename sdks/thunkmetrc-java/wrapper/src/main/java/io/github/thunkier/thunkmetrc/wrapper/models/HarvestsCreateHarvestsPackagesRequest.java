...
import com.fasterxml.jackson.annotation.JsonProperty;public class HarvestsCreateHarvestsPackagesRequest {
    ...
    public static class HarvestsCreateHarvestsPackagesRequestIngredientsItem {
