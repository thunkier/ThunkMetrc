...
import com.fasterxml.jackson.annotation.JsonProperty;public class PackagesCreateTestingRequestItem {
    ...
    public static class PackagesCreateTestingRequestItemIngredientsItem {
