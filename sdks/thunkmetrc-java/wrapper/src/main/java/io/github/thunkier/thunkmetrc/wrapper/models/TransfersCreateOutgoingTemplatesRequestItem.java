...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersCreateOutgoingTemplatesRequestItem {
    ...
    public static class TransfersCreateOutgoingTemplatesRequestItemDestinationsItemPackagesItem {
...
}public static class TransfersCreateOutgoingTemplatesRequestItemDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateOutgoingTemplatesRequestItemDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateOutgoingTemplatesRequestItemDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
