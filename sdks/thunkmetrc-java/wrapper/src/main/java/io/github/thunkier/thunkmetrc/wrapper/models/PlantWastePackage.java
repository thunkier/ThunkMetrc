...
import com.fasterxml.jackson.annotation.JsonProperty;public class PlantWastePackage {
    ...
    @JsonProperty("Item")
    public PlantsPlantWastePackageItem item;
    ...
    public PlantsPlantWastePackageProductLabel productLabel;
    ...
    public static class PlantsPlantWastePackageItem {
    ...
    public static class PlantsPlantWastePackageProductLabel {
