...
import com.fasterxml.jackson.annotation.JsonProperty;public class ProcessingJobCreateAdjustProcessingJobRequestItem {
    ...
    public static class ProcessingJobCreateAdjustProcessingJobRequestItemPackagesItem {
    @JsonProperty("Label")
    public String label;
