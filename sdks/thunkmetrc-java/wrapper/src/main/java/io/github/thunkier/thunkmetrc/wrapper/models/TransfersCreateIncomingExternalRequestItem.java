...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersCreateIncomingExternalRequestItem {
    ...
    public static class TransfersCreateIncomingExternalRequestItemDestinationsItemPackagesItem {
...
}public static class TransfersCreateIncomingExternalRequestItemDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateIncomingExternalRequestItemDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateIncomingExternalRequestItemDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
