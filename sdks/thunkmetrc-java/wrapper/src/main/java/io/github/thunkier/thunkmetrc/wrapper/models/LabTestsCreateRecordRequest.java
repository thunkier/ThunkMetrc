...
import com.fasterxml.jackson.annotation.JsonProperty;public class LabTestsCreateRecordRequest {
    ...
    public static class LabTestsCreateRecordRequestResultsItem {
