...
import com.fasterxml.jackson.annotation.JsonProperty;public class AdditivesTemplatesUpdateAdditivesTemplatesRequest {
    ...
    public static class AdditivesTemplatesUpdateAdditivesTemplatesRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
