...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreateAdditivesByLocationRequest {
    ...
    public static class CreateAdditivesByLocationRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
