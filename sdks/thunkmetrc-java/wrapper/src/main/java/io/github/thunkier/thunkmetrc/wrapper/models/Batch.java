...
import com.fasterxml.jackson.annotation.JsonProperty;public class Batch {
    @JsonProperty("Id")
    public Integer id;
    @JsonProperty("ItemCategories")
    public List<LabTestsBatchItemCategoriesItem> itemCategories;
    @JsonProperty("ItemCategoryCount")
    public Integer itemCategoryCount;
    @JsonProperty("LabTestTypeCount")
    public Integer labTestTypeCount;
    @JsonProperty("LabTestTypes")
    public List<LabTestsBatchLabTestTypesItem> labTestTypes;
    @JsonProperty("Name")
    public String name;
    @JsonProperty("RequiresAllFromLabTestBatch")
    public Boolean requiresAllFromLabTestBatch;
    public static class LabTestsBatchItemCategoriesItemProductCategory {
    ...
    public String maxDaysForRecoveryAfterFailure;
    @JsonProperty("MaxDaysToMaintainRTA")
    public String maxDaysToMaintainRTA;
    @JsonProperty("MaxDaysWithoutTestedSource")
    public String maxDaysWithoutTestedSource;
    @JsonProperty("MaxDaystoReachMinSources")
    public String maxDaystoReachMinSources;
    @JsonProperty("MaxRepackageDistanceFromSource")
    public String maxRepackageDistanceFromSource;
    @JsonProperty("MinConsecutiveSourcesForRTA")
    public String minConsecutiveSourcesForRTA;
    @JsonProperty("MinDaysForRTA")
    public String minDaysForRTA;
    @JsonProperty("MinNewPassesInRecoveryWindow")
    public String minNewPassesInRecoveryWindow;
    @JsonProperty("Name")
    public String name;
...
}public static class LabTestsBatchItemCategoriesItem {
    @JsonProperty("ProductCategory")
    public LabTestsBatchItemCategoriesItemProductCategory productCategory;
    @JsonProperty("ProductCategoryId")
    public String productCategoryId;
    @JsonProperty("RequireLabTestBatch")
    public Boolean requireLabTestBatch;
}
    public static class LabTestsBatchLabTestTypesItem {
