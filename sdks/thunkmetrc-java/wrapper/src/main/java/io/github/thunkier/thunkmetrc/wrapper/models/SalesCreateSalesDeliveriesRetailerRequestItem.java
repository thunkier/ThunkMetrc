...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateSalesDeliveriesRetailerRequestItem {
...
}public static class SalesCreateSalesDeliveriesRetailerRequestItemDestinationsItem {
    ...
    public static class SalesCreateSalesDeliveriesRetailerRequestItemPackagesItem {
    @JsonProperty("DateTime")
    public String dateTime;
    @JsonProperty("PackageLabel")
    public String packageLabel;
