...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateDeliveriesRequestItem {
    ...
    public static class SalesCreateDeliveriesRequestItemTransactionsItem {
