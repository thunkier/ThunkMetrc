...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreateAdjustProcessingJobRequest {
    ...
    public static class CreateAdjustProcessingJobRequestPackagesItem {
    @JsonProperty("Label")
    public String label;
