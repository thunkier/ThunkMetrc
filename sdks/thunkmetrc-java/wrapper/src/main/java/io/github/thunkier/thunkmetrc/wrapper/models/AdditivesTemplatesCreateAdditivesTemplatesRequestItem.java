...
import com.fasterxml.jackson.annotation.JsonProperty;public class AdditivesTemplatesCreateAdditivesTemplatesRequestItem {
    ...
    public static class AdditivesTemplatesCreateAdditivesTemplatesRequestItemActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
