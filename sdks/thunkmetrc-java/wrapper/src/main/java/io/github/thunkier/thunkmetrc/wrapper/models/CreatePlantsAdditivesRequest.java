...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreatePlantsAdditivesRequest {
    ...
    public static class CreatePlantsAdditivesRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
