...
import com.fasterxml.jackson.annotation.JsonProperty;public class PackagesCreatePackagesPackagesRequestItem {
    ...
    public static class PackagesCreatePackagesPackagesRequestItemIngredientsItem {
