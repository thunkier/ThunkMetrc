...
import com.fasterxml.jackson.annotation.JsonProperty;public class ProcessingJobStartProcessingJobRequest {
    ...
    public static class ProcessingJobStartProcessingJobRequestPackagesItem {
    @JsonProperty("Label")
    public String label;
