...
import com.fasterxml.jackson.annotation.JsonProperty;public class PlantsCreatePlantsAdditivesRequestItem {
    ...
    public static class PlantsCreatePlantsAdditivesRequestItemActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
