...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesUpdateSaleDeliveriesRetailerRequestItem {
    @JsonProperty("DateTime")
    public String dateTime;
    @JsonProperty("Destinations")
    public List<SalesUpdateSaleDeliveriesRetailerRequestItemDestinations> destinations;
    ...
    public List<SalesUpdateSaleDeliveriesRetailerRequestItemPackages> packages;
...
}public static class SalesUpdateSaleDeliveriesRetailerRequestItemDestinations {
    ...
    public static class SalesUpdateSaleDeliveriesRetailerRequestItemPackages {
    @JsonProperty("DateTime")
    public String dateTime;
    @JsonProperty("PackageLabel")
    public String packageLabel;
