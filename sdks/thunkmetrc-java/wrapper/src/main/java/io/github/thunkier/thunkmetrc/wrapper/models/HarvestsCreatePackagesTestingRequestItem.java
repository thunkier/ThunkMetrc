...
import com.fasterxml.jackson.annotation.JsonProperty;public class HarvestsCreatePackagesTestingRequestItem {
    ...
    public static class HarvestsCreatePackagesTestingRequestItemIngredientsItem {
