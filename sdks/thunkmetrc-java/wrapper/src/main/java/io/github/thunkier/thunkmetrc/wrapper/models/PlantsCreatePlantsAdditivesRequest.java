...
import com.fasterxml.jackson.annotation.JsonProperty;public class PlantsCreatePlantsAdditivesRequest {
    ...
    public static class PlantsCreatePlantsAdditivesRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
