...
import com.fasterxml.jackson.annotation.JsonProperty;public class HarvestsCreatePackagesTestingRequest {
    ...
    public static class HarvestsCreatePackagesTestingRequestIngredientsItem {
