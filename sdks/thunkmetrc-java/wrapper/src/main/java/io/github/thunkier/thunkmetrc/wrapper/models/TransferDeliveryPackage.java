...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransferDeliveryPackage {
    ...
    public TransfersTransferDeliveryPackageProductLabel productLabel;
    ...
    public static class TransfersTransferDeliveryPackageProductLabel {
