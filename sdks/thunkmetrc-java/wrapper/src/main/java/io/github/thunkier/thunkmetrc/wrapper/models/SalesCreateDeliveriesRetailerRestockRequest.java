...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateDeliveriesRetailerRestockRequest {
    ...
    public static class SalesCreateDeliveriesRetailerRestockRequestPackagesItem {
