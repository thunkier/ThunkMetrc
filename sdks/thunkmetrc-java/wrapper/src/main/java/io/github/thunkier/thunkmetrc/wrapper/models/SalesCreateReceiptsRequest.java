...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateReceiptsRequest {
    ...
    public static class SalesCreateReceiptsRequestTransactionsItem {
