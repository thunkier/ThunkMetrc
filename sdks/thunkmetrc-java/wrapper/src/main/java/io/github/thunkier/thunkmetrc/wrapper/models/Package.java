...
import com.fasterxml.jackson.annotation.JsonProperty;public class Package {
    ...
    public PackageProductLabel productLabel;
    ...
    public Integer testResultLevel;
    ...
    public static class PackageProductLabel {
