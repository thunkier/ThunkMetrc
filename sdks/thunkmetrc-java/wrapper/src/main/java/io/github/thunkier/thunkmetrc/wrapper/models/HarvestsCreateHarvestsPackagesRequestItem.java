...
import com.fasterxml.jackson.annotation.JsonProperty;public class HarvestsCreateHarvestsPackagesRequestItem {
    ...
    public static class HarvestsCreateHarvestsPackagesRequestItemIngredientsItem {
