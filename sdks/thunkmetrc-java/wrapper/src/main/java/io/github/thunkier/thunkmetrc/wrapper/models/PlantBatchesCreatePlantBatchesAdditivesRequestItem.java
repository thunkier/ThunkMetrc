...
import com.fasterxml.jackson.annotation.JsonProperty;public class PlantBatchesCreatePlantBatchesAdditivesRequestItem {
    ...
    public static class PlantBatchesCreatePlantBatchesAdditivesRequestItemActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
