...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateDeliveriesRequest {
    ...
    public static class SalesCreateDeliveriesRequestTransactionsItem {
