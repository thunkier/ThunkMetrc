...
import com.fasterxml.jackson.annotation.JsonProperty;public class UpdateAdditivesTemplatesRequest {
    ...
    public static class UpdateAdditivesTemplatesRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
