...
import com.fasterxml.jackson.annotation.JsonProperty;public class PlantBatchesCreatePlantBatchesAdditivesRequest {
    ...
    public static class PlantBatchesCreatePlantBatchesAdditivesRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
