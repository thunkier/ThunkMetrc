...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesUpdateDeliveriesRequest {
    ...
    public static class SalesUpdateDeliveriesRequestTransactionsItem {
