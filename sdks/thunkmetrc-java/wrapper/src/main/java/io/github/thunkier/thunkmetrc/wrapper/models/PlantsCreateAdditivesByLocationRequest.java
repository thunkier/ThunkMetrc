...
import com.fasterxml.jackson.annotation.JsonProperty;public class PlantsCreateAdditivesByLocationRequest {
    ...
    public static class PlantsCreateAdditivesByLocationRequestActiveIngredientsItem {
    @JsonProperty("Name")
    public String name;
