...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersUpdateIncomingExternalRequestItem {
    ...
    public static class TransfersUpdateIncomingExternalRequestItemDestinationsItemPackagesItem {
...
}public static class TransfersUpdateIncomingExternalRequestItemDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersUpdateIncomingExternalRequestItemDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersUpdateIncomingExternalRequestItemDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
