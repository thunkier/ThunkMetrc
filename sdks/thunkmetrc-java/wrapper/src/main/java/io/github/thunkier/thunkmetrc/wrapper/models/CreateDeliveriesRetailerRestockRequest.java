...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreateDeliveriesRetailerRestockRequest {
    ...
    public static class CreateDeliveriesRetailerRestockRequestPackagesItem {
