...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesUpdateDeliveriesCompleteRequest {
    ...
    public static class SalesUpdateDeliveriesCompleteRequestReturnedPackagesItem {
    @JsonProperty("Label")
    public String label;
