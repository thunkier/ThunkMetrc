...
import com.fasterxml.jackson.annotation.JsonProperty;public class DeliveryRetailer {
    ...
    public List<SalesDeliveryRetailerDestinationsItem> destinations;
    ...
    public List<SalesDeliveryRetailerPackagesItem> packages;
    ...
    public static class SalesDeliveryRetailerDestinationsItem {
    @JsonProperty("AcceptedDateTime")
    public String acceptedDateTime;
    ...
    public static class SalesDeliveryRetailerPackagesItem {
