...
import com.fasterxml.jackson.annotation.JsonProperty;public class PackagesCreatePackagesRequestItem {
    @JsonProperty("ActualDate")
    public String actualDate;
    @JsonProperty("ExpirationDate")
    public String expirationDate;
    @JsonProperty("Ingredients")
    public List<PackagesCreatePackagesRequestItemIngredients> ingredients;
    ...
    public static class PackagesCreatePackagesRequestItemIngredients {
