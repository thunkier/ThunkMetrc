...
import com.fasterxml.jackson.annotation.JsonProperty;public class PlantsCreatePlantAdditivesByLocationRequestItem {
    @JsonProperty("ActiveIngredients")
    public List<PlantsCreatePlantAdditivesByLocationRequestItemActiveIngredients> activeIngredients;
    ...
    public static class PlantsCreatePlantAdditivesByLocationRequestItemActiveIngredients {
    @JsonProperty("Name")
    public String name;
