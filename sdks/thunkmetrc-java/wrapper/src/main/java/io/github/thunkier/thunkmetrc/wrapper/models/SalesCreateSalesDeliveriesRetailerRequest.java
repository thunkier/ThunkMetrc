...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateSalesDeliveriesRetailerRequest {
    ...
    public static class SalesCreateSalesDeliveriesRetailerRequestTransactionsItem {
