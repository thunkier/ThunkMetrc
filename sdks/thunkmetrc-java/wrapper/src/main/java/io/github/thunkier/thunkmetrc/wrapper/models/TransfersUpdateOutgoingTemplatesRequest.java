...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersUpdateOutgoingTemplatesRequest {
    ...
    public static class TransfersUpdateOutgoingTemplatesRequestDestinationsItemPackagesItem {
...
}public static class TransfersUpdateOutgoingTemplatesRequestDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersUpdateOutgoingTemplatesRequestDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersUpdateOutgoingTemplatesRequestDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
