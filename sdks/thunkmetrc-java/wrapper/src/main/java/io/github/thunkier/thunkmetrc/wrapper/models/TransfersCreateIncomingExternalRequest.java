...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersCreateIncomingExternalRequest {
    ...
    public static class TransfersCreateIncomingExternalRequestDestinationsItemPackagesItem {
...
}public static class TransfersCreateIncomingExternalRequestDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateIncomingExternalRequestDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateIncomingExternalRequestDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
