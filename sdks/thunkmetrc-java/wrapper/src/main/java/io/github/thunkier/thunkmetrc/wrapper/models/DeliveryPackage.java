...
import com.fasterxml.jackson.annotation.JsonProperty;public class DeliveryPackage {
    ...
    public TransfersDeliveryPackageProductLabel productLabel;
    ...
    public static class TransfersDeliveryPackageProductLabel {
