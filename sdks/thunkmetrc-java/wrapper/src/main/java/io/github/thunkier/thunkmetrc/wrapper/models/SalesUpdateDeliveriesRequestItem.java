...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesUpdateDeliveriesRequestItem {
    ...
    public static class SalesUpdateDeliveriesRequestItemTransactionsItem {
