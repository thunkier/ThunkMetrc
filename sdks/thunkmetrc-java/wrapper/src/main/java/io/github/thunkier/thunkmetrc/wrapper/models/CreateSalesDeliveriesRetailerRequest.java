...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreateSalesDeliveriesRetailerRequest {
    ...
    public static class CreateSalesDeliveriesRetailerRequestTransactionsItem {
