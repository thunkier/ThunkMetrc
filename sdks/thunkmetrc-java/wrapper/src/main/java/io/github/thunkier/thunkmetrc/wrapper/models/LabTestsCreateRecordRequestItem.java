...
import com.fasterxml.jackson.annotation.JsonProperty;public class LabTestsCreateRecordRequestItem {
    ...
    public static class LabTestsCreateRecordRequestItemResultsItem {
