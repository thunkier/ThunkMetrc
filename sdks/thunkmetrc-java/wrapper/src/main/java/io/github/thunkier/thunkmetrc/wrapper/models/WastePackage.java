...
import com.fasterxml.jackson.annotation.JsonProperty;public class WastePackage {
    ...
    @JsonProperty("Item")
    public PlantsWastePackageItem item;
    ...
    public PlantsWastePackageProductLabel productLabel;
    ...
    public static class PlantsWastePackageItem {
    ...
    public static class PlantsWastePackageProductLabel {
