...
import com.fasterxml.jackson.annotation.JsonProperty;public class InTransit {
    ...
    @JsonProperty("Item")
    public PackagesInTransitItem item;
    ...
    public PackagesInTransitProductLabel productLabel;
    ...
    public static class PackagesInTransitItem {
    ...
    public static class PackagesInTransitProductLabel {
