...
import com.fasterxml.jackson.annotation.JsonProperty;public class LabTestBatche {
    @JsonProperty("Id")
    public Integer id;
    @JsonProperty("ItemCategories")
    public List<LabTestsLabTestBatcheItemCategoriesItem> itemCategories;
    ...
    public List<LabTestsLabTestBatcheLabTestTypesItem> labTestTypes;
    @JsonProperty("Name")
    public String name;
    @JsonProperty("RequiresAllFromLabTestBatch")
    public Boolean requiresAllFromLabTestBatch;
    public static class LabTestsLabTestBatcheItemCategoriesItemProductCategory {
...
}public static class LabTestsLabTestBatcheItemCategoriesItem {
    @JsonProperty("ProductCategory")
    public LabTestsLabTestBatcheItemCategoriesItemProductCategory productCategory;
    @JsonProperty("ProductCategoryId")
    public String productCategoryId;
    @JsonProperty("RequireLabTestBatch")
    public Boolean requireLabTestBatch;
}
    public static class LabTestsLabTestBatcheLabTestTypesItem {
