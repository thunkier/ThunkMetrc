...
import com.fasterxml.jackson.annotation.JsonProperty;public class PackagesCreatePackagesPackagesRequest {
    ...
    public static class PackagesCreatePackagesPackagesRequestIngredientsItem {
