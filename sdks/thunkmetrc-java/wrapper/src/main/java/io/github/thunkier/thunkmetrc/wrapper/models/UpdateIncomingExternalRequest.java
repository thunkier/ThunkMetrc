...
import com.fasterxml.jackson.annotation.JsonProperty;public class UpdateIncomingExternalRequest {
    ...
    public static class UpdateIncomingExternalRequestDestinationsItemPackagesItem {
...
}public static class UpdateIncomingExternalRequestDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class UpdateIncomingExternalRequestDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class UpdateIncomingExternalRequestDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
