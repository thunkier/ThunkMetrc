...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersCreateIncomingTransferExternalRequestItem {
    @JsonProperty("Destinations")
    public List<TransfersCreateIncomingTransferExternalRequestItemDestinations> destinations;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateIncomingTransferExternalRequestItemDestinations {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
