...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreatePackagesTestingRequest {
    ...
    public static class CreatePackagesTestingRequestIngredientsItem {
