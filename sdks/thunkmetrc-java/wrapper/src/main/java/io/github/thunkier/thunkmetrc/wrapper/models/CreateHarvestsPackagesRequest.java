...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreateHarvestsPackagesRequest {
    ...
    public static class CreateHarvestsPackagesRequestIngredientsItem {
