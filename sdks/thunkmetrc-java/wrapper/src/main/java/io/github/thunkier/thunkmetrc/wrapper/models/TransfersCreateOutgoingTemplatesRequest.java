...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersCreateOutgoingTemplatesRequest {
    ...
    public static class TransfersCreateOutgoingTemplatesRequestDestinationsItemPackagesItem {
...
}public static class TransfersCreateOutgoingTemplatesRequestDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateOutgoingTemplatesRequestDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateOutgoingTemplatesRequestDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
