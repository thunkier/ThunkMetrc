...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersCreateOutgoingTransferTemplatesRequestItem {
    @JsonProperty("Destinations")
    public List<TransfersCreateOutgoingTransferTemplatesRequestItemDestinations> destinations;
    ...
    public static class TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsPackages {
...
}public static class TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsTransportersTransporterDetails {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsTransporters {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    public List<TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsTransportersTransporterDetails> transporterDetails;
    @JsonProperty("TransporterFacilityLicenseNumber")
    public String transporterFacilityLicenseNumber;
    @JsonProperty("VehicleLicensePlateNumber")
    public String vehicleLicensePlateNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersCreateOutgoingTransferTemplatesRequestItemDestinations {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
    ...
    public List<TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsPackages> packages;
    ...
    public List<TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsTransporters> transporters;
}
}
