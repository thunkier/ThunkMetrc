...
import com.fasterxml.jackson.annotation.JsonProperty;public class PackagesCreateTestingRequest {
    ...
    public static class PackagesCreateTestingRequestIngredientsItem {
