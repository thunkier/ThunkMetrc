...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateReceiptsRequestItem {
    ...
    public static class SalesCreateReceiptsRequestItemTransactionsItem {
