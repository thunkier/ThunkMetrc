...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesCreateDeliveriesRetailerEndRequest {
    ...
    public static class SalesCreateDeliveriesRetailerEndRequestPackagesItem {
