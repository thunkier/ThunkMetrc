...
import com.fasterxml.jackson.annotation.JsonProperty;public class UpdateDeliveriesRetailerRequest {
    ...
    public static class UpdateDeliveriesRetailerRequestDestinationsItemTransactionsItem {
...
}public static class UpdateDeliveriesRetailerRequestDestinationsItem {
    ...
    public static class UpdateDeliveriesRetailerRequestPackagesItem {
    @JsonProperty("DateTime")
    public String dateTime;
    @JsonProperty("PackageLabel")
    public String packageLabel;
