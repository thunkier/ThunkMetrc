...
import com.fasterxml.jackson.annotation.JsonProperty;public class CreateIncomingExternalRequest {
    ...
    public static class CreateIncomingExternalRequestDestinationsItemPackagesItem {
...
}public static class CreateIncomingExternalRequestDestinationsItemTransportersItemTransporterDetailsItem {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class CreateIncomingExternalRequestDestinationsItemTransportersItem {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class CreateIncomingExternalRequestDestinationsItem {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
