...
import com.fasterxml.jackson.annotation.JsonProperty;public class SalesUpdateReceiptsRequestItem {
    ...
    public static class SalesUpdateReceiptsRequestItemTransactionsItem {
