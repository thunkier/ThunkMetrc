...
import com.fasterxml.jackson.annotation.JsonProperty;public class TransfersUpdateOutgoingTransferTemplatesRequestItem {
    @JsonProperty("Destinations")
    public List<TransfersUpdateOutgoingTransferTemplatesRequestItemDestinations> destinations;
    ...
    public static class TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsPackages {
...
}public static class TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsTransportersTransporterDetails {
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsTransporters {
    @JsonProperty("DriverLayoverLeg")
    public String driverLayoverLeg;
    @JsonProperty("DriverLicenseNumber")
    public String driverLicenseNumber;
    ...
    public List<TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsTransportersTransporterDetails> transporterDetails;
    @JsonProperty("TransporterFacilityLicenseNumber")
    public String transporterFacilityLicenseNumber;
    @JsonProperty("VehicleLicensePlateNumber")
    public String vehicleLicensePlateNumber;
    ...
    @JsonProperty("VehicleModel")
    public String vehicleModel;
}public static class TransfersUpdateOutgoingTransferTemplatesRequestItemDestinations {
    @JsonProperty("EstimatedArrivalDateTime")
    public String estimatedArrivalDateTime;
    @JsonProperty("EstimatedDepartureDateTime")
    public String estimatedDepartureDateTime;
    ...
    public List<TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsPackages> packages;
    ...
    public List<TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsTransporters> transporters;
}
}
