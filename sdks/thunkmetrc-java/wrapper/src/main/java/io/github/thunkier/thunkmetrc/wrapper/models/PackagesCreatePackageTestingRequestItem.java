...
import com.fasterxml.jackson.annotation.JsonProperty;public class PackagesCreatePackageTestingRequestItem {
    @JsonProperty("ActualDate")
    public String actualDate;
    @JsonProperty("ExpirationDate")
    public String expirationDate;
    @JsonProperty("Ingredients")
    public List<PackagesCreatePackageTestingRequestItemIngredients> ingredients;
    ...
    public static class PackagesCreatePackageTestingRequestItemIngredients {
