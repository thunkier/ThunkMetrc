...
{
    public class TemplateDeliveryPackage
    {
        ...
        public required TransfersTemplateDeliveryPackageProductLabel ProductLabel { get; set; }
        ...
        public class TransfersTemplateDeliveryPackageProductLabel
        {
