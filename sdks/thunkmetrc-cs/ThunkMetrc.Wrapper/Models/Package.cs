...
namespace ThunkMetrc.Wrapper.Models
{
    public class Package
    {
        ...
        public required string FinishedDate { get; set; }
        ...
        public required PackageItem Item { get; set; }
        ...
        public required string LabTestStage { get; set; }
        [global::System.Text.Json.Serialization.JsonPropertyName("LabTestStageId")]
        public required int LabTestStageId { get; set; }
        ...
        public required PackageProductLabel ProductLabel { get; set; }
        ...
        public required int TestResultLevel { get; set; }
        ...
        public class PackageProductLabel
        {
