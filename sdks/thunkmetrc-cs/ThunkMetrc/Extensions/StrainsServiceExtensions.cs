...
/// <summary>
/// Extension methods for StrainsService.
/// </summary>
public static class StrainsServiceExtensions
{
    /// <summary>
    ...
    public static async IAsyncEnumerable<Strain> IterateGetActiveStrains(
        this StrainsService service,
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        {
            var response = await service.GetActiveStrains(
    ...
    /// <summary>
    /// Syncs GetActiveStrains data for a specific time window.
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    public static async Task<List<Strain>> SyncGetActiveStrains(
        this StrainsService service,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var results = new List<Strain>();
        await foreach (var item in service.IterateGetActiveStrains(
    ...
    /// <summary>
    /// Parallel Sync for GetActiveStrains across multiple targets.
    /// </summary>
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    public static async Task<Dictionary<string, List<Strain>>> SyncGetActiveStrainsParallel(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await MetrcExtensions.ParallelSyncAsync<Strain>(
            targets,
            concurrencyLimit,
            async (target, ct) => 
            {
               var list = new List<Strain>();
               await foreach (var item in target.Wrapper.Strains.IterateGetActiveStrains(
    ...
    /// <param name="pageSize">The number of records to return per page. Pagination is currently disabled by default. You can enable pagination on this query by specifying a value that does not exceed 20.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    public static async IAsyncEnumerable<Strain> IterateGetInactiveStrains(
        this StrainsService service,
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        while (!cancellationToken.IsCancellationRequested)
        {
            var response = await service.GetInactiveStrains(
