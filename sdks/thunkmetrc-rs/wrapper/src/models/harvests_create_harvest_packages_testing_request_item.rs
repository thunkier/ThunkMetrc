...
pub struct HarvestsCreateHarvestPackagesTestingRequestItem {
    #[serde(rename = "actual_date", skip_serializing_if = "Option::is_none")]
    pub actual_date: Option<String>,
    #[serde(rename = "decontaminate_product", skip_serializing_if = "Option::is_none")]
    ...
    pub ingredients: Option<Vec<HarvestsCreateHarvestPackagesTestingRequestItemIngredientsItem>>,
    ...
    #[serde(rename = "product_requires_decontamination", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "remediate_product", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "remediation_method_id", skip_serializing_if = "Option::is_none")]
