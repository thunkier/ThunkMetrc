...
pub struct TransfersUpdateIncomingTransferExternalRequestItem {
    #[serde(rename = "destinations", skip_serializing_if = "Option::is_none")]
    pub destinations: Option<Vec<TransfersUpdateIncomingTransferExternalRequestItemDestinationsItem>>,
