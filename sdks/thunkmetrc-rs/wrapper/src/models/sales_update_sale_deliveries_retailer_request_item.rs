...
pub struct SalesUpdateSaleDeliveriesRetailerRequestItem {
    ...
    pub destinations: Option<Vec<SalesUpdateSaleDeliveriesRetailerRequestItemDestinationsItem>>,
    ...
    pub packages: Option<Vec<SalesUpdateSaleDeliveriesRetailerRequestItemPackagesItem>>,
