...
pub struct LabTestBatche {
    #[serde(rename = "Id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i64>,
    #[serde(rename = "ItemCategories", skip_serializing_if = "Option::is_none")]
    pub item_categories: Option<Vec<LabTestsLabTestBatcheItemCategoriesItem>>,
    ...
    pub lab_test_types: Option<Vec<LabTestsLabTestBatcheLabTestTypesItem>>,
