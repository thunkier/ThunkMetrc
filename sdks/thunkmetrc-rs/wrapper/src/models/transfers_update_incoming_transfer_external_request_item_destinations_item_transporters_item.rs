...
pub struct TransfersUpdateIncomingTransferExternalRequestItemDestinationsItemTransportersItem {
    ...
    pub transporter_details: Option<Vec<TransfersUpdateIncomingTransferExternalRequestItemDestinationsItemTransportersItemTransporterDetailsItem>>,
