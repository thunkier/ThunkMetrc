...
pub struct TransfersCreateIncomingTransferExternalRequestItemDestinationsItemTransportersItem {
    ...
    pub transporter_details: Option<Vec<TransfersCreateIncomingTransferExternalRequestItemDestinationsItemTransportersItemTransporterDetailsItem>>,
