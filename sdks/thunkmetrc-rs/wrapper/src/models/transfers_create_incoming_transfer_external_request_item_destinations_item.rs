...
pub struct TransfersCreateIncomingTransferExternalRequestItemDestinationsItem {
    ...
    pub packages: Option<Vec<TransfersCreateIncomingTransferExternalRequestItemDestinationsItemPackagesItem>>,
    ...
    pub transporters: Option<Vec<TransfersCreateIncomingTransferExternalRequestItemDestinationsItemTransportersItem>>,
}
