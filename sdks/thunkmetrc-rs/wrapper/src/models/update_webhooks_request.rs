...
pub struct UpdateWebhooksRequest {
    #[serde(rename = "errorResponseJsonTemplate", skip_serializing_if = "Option::is_none")]
    pub error_response_json_template: Option<String>,
    #[serde(rename = "facilityLicenseNumbers", skip_serializing_if = "Option::is_none")]
    pub facility_license_numbers: Option<String>,
    #[serde(rename = "objectType", skip_serializing_if = "Option::is_none")]
    pub object_type: Option<String>,
    #[serde(rename = "serverPublicKeyFingerprint", skip_serializing_if = "Option::is_none")]
    pub server_public_key_fingerprint: Option<String>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "template", skip_serializing_if = "Option::is_none")]
    pub template: Option<String>,
    #[serde(rename = "tpiApiKey", skip_serializing_if = "Option::is_none")]
    pub tpi_api_key: Option<String>,
    #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
    #[serde(rename = "userApiKey", skip_serializing_if = "Option::is_none")]
