...
pub struct TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsItem {
    ...
    pub packages: Option<Vec<TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsItemPackagesItem>>,
    ...
    pub transporters: Option<Vec<TransfersCreateOutgoingTransferTemplatesRequestItemDestinationsItemTransportersItem>>,
}
