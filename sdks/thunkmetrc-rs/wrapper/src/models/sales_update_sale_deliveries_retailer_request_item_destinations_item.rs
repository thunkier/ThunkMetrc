...
pub struct SalesUpdateSaleDeliveriesRetailerRequestItemDestinationsItem {
    ...
    pub transactions: Option<Vec<SalesUpdateSaleDeliveriesRetailerRequestItemDestinationsItemTransactionsItem>>,
