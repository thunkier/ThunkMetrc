...
pub struct TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsItemTransportersItem {
    ...
    pub transporter_details: Option<Vec<TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsItemTransportersItemTransporterDetailsItem>>,
