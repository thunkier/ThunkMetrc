...
pub struct PlantBatchesCreatePlantBatchAdditivesRequestItem {
    #[serde(rename = "active_ingredients", skip_serializing_if = "Option::is_none")]
    pub active_ingredients: Option<Vec<PlantBatchesCreatePlantBatchAdditivesRequestItemActiveIngredientsItem>>,
