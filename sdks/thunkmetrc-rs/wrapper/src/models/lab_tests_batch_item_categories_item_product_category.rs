...
pub struct LabTestsBatchItemCategoriesItemProductCategory {
    ...
    #[serde(rename = "MaxDaysForRecoveryAfterFailure", skip_serializing_if = "Option::is_none")]
    pub max_days_for_recovery_after_failure: Option<String>,
    #[serde(rename = "MaxDaysToMaintainRTA", skip_serializing_if = "Option::is_none")]
    pub max_days_to_maintain_rta: Option<String>,
    #[serde(rename = "MaxDaysWithoutTestedSource", skip_serializing_if = "Option::is_none")]
    pub max_days_without_tested_source: Option<String>,
    #[serde(rename = "MaxDaystoReachMinSources", skip_serializing_if = "Option::is_none")]
    pub max_daysto_reach_min_sources: Option<String>,
    #[serde(rename = "MaxRepackageDistanceFromSource", skip_serializing_if = "Option::is_none")]
    pub max_repackage_distance_from_source: Option<String>,
    #[serde(rename = "MinConsecutiveSourcesForRTA", skip_serializing_if = "Option::is_none")]
    pub min_consecutive_sources_for_rta: Option<String>,
    #[serde(rename = "MinDaysForRTA", skip_serializing_if = "Option::is_none")]
    pub min_days_for_rta: Option<String>,
    #[serde(rename = "MinNewPassesInRecoveryWindow", skip_serializing_if = "Option::is_none")]
    pub min_new_passes_in_recovery_window: Option<String>,
