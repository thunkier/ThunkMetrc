...
class SaleDeliveryRetailer(TypedDict, total=False):
    AcceptedDateTime: str
    ActualDepartureDateTime: str
    AllowFullEdit: bool
    CompletedDateTime: str
    DateTime: str
    Destinations: List['SalesSaleDeliveryRetailerDestinationsItem']
    Direction: str
    ...
    LastModified: str
    Leg: int
    Packages: List['SalesSaleDeliveryRetailerPackagesItem']
