...
public class IntegrationTest {
    ...
    public void testActivePackagesInventorySync() throws Exception {
        ...
        String licenseNumber = getEnv(dotenv, "METRC_LICENSE_NUMBER");

        if (baseUrl == null) baseUrl = "https://sandbox-api-or.metrc.com";
        
        if (vendorKey == null || userKey == null || licenseNumber == null) {
            System.out.println("Skipping test: Missing METRC_VENDOR_API_KEY, METRC_USER_API_KEY, or METRC_LICENSE_NUMBER");
            return;
        }
        ...
        List<Object> packages = thunk.activePackagesInventorySync(licenseNumber, null, 5);
