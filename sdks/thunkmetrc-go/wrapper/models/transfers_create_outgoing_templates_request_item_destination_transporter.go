...
type TransfersCreateOutgoingTemplatesRequestItemDestinationTransporter struct {
    ...
    TransporterDetails []*TransfersCreateOutgoingTemplatesRequestItemDestinationTransporterTransporterDetail `json:"TransporterDetails,omitempty"`
