...
type HarvestsCreateHarvestPackagesTestingRequestItem struct {
    ...
    Ingredients []*HarvestsCreateHarvestPackagesTestingRequestItemIngredient `json:"Ingredients,omitempty"`
