...
type TransfersCreateOutgoingTransferTemplatesRequestItemDestinationTransporter struct {
    ...
    TransporterDetails []*TransfersCreateOutgoingTransferTemplatesRequestItemDestinationTransporterTransporterDetail `json:"TransporterDetails,omitempty"`
