...
type SaleDeliveryRetailer struct {
    ...
    Destinations []SalesSaleDeliveryRetailerDestinationsItem `json:"Destinations,omitempty"`
    ...
    Packages []SalesSaleDeliveryRetailerPackagesItem `json:"Packages,omitempty"`
