...
type TransfersUpdateIncomingTransferExternalRequestItem struct {
    Destinations []*TransfersUpdateIncomingTransferExternalRequestItemDestination `json:"Destinations,omitempty"`
