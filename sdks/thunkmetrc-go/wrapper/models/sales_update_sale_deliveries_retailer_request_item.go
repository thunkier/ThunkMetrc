...
type SalesUpdateSaleDeliveriesRetailerRequestItem struct {
    DateTime string `json:"DateTime,omitempty"`
    Destinations []*SalesUpdateSaleDeliveriesRetailerRequestItemDestination `json:"Destinations,omitempty"`
    ...
    Packages []*SalesUpdateSaleDeliveriesRetailerRequestItemPackage `json:"Packages,omitempty"`
