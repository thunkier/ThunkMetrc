...
type TransfersCreateIncomingTransferExternalRequestItemDestinationTransporter struct {
    ...
    TransporterDetails []*TransfersCreateIncomingTransferExternalRequestItemDestinationTransporterTransporterDetail `json:"TransporterDetails,omitempty"`
