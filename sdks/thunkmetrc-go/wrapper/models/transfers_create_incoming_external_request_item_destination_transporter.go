...
type TransfersCreateIncomingExternalRequestItemDestinationTransporter struct {
    ...
    TransporterDetails []*TransfersCreateIncomingExternalRequestItemDestinationTransporterTransporterDetail `json:"TransporterDetails,omitempty"`
