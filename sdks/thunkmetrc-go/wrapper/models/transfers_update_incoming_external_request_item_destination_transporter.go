...
type TransfersUpdateIncomingExternalRequestItemDestinationTransporter struct {
    ...
    TransporterDetails []*TransfersUpdateIncomingExternalRequestItemDestinationTransporterTransporterDetail `json:"TransporterDetails,omitempty"`
