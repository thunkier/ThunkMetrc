...
type PlantsCreatePlantAdditivesByLocationRequestItem struct {
    ActiveIngredients []*PlantsCreatePlantAdditivesByLocationRequestItemActiveIngredient `json:"ActiveIngredients,omitempty"`
