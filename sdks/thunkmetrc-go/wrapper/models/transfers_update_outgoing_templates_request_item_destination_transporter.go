...
type TransfersUpdateOutgoingTemplatesRequestItemDestinationTransporter struct {
    ...
    TransporterDetails []*TransfersUpdateOutgoingTemplatesRequestItemDestinationTransporterTransporterDetail `json:"TransporterDetails,omitempty"`
