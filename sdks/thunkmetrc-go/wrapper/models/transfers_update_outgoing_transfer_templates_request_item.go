...
type TransfersUpdateOutgoingTransferTemplatesRequestItem struct {
    Destinations []*TransfersUpdateOutgoingTransferTemplatesRequestItemDestination `json:"Destinations,omitempty"`
