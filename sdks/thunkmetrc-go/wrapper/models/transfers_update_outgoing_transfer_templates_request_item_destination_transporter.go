...
type TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationTransporter struct {
    ...
    TransporterDetails []*TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationTransporterTransporterDetail `json:"TransporterDetails,omitempty"`
