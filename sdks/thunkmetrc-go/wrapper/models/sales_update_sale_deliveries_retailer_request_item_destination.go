...
type SalesUpdateSaleDeliveriesRetailerRequestItemDestination struct {
    ...
    Transactions []*SalesUpdateSaleDeliveriesRetailerRequestItemDestinationTransaction `json:"Transactions,omitempty"`
