...
type PlantBatchesCreatePlantBatchAdditivesRequestItem struct {
    ActiveIngredients []*PlantBatchesCreatePlantBatchAdditivesRequestItemActiveIngredient `json:"ActiveIngredients,omitempty"`
