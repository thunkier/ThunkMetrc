...
type PlantWastePackage struct {
    ...
    Item PlantsPlantWastePackageItem `json:"Item,omitempty"`
    ...
    ProductLabel PlantsPlantWastePackageProductLabel `json:"ProductLabel,omitempty"`
