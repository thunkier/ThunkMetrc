...
data class TransfersUpdateIncomingTransferExternalRequestItemDestinationsTransporters(
    ...
    val transporterDetails: List<TransfersUpdateIncomingTransferExternalRequestItemDestinationsTransportersTransporterDetails>? = null,
