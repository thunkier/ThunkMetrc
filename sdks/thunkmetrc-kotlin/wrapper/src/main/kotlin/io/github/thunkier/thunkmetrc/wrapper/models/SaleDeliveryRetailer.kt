...
data class SaleDeliveryRetailer(
    ...
    val destinations: List<SalesSaleDeliveryRetailerDestinationsItem>? = null,
    ...
    val packages: List<SalesSaleDeliveryRetailerPackagesItem>? = null,
