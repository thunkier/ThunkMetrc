...
data class TransfersCreateIncomingTransferExternalRequestItemDestinationsTransporters(
    ...
    val transporterDetails: List<TransfersCreateIncomingTransferExternalRequestItemDestinationsTransportersTransporterDetails>? = null,
