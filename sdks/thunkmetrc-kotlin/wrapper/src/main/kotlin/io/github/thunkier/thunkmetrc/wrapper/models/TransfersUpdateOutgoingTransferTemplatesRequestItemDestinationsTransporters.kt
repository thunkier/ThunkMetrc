...
data class TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsTransporters(
    ...
    val transporterDetails: List<TransfersUpdateOutgoingTransferTemplatesRequestItemDestinationsTransportersTransporterDetails>? = null,
