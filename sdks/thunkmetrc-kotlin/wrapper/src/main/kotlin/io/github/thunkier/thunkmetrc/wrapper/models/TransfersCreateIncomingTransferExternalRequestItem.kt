...
data class TransfersCreateIncomingTransferExternalRequestItem(
    @JsonProperty("destinations")
    val destinations: List<TransfersCreateIncomingTransferExternalRequestItemDestinations>? = null,
